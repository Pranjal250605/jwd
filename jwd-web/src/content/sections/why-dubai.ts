          ...
          items: [
            {
              ...
              text: {
                ja: '一定額以上の不動産投資や事業・専門人材を対象に、長期の居住を認める制度。家族も帯同可能。',
                en: 'Long-term residency for qualifying property investment, entrepreneurs and specialists — with family included.',
              },
            },
            {
              icon: 'home',
              ...
              text: {
                ja: '一定基準を満たす不動産取得に紐づく居住ビザ。物件保有を起点に滞在資格を得られます。',
                en: 'Residency tied to qualifying property ownership — your asset becomes the basis of your right to stay.',
              },
            },
            {
              icon: 'briefcase',
              ...
              text: {
                ja: 'フリーゾーン法人の設立と連動した就労ビザ。エミレーツIDや銀行口座開設の前提にもなります。',
                en: 'An employment visa linked to free-zone company formation — also the basis for Emirates ID and bank accounts.',
              },
            },
          ],
        },
