          ...
          items: [
            {
              ...
              text: {
                ja: 'プロ運営による安定稼働を前提に、賃貸運用の手間を抑えて収益を狙えます。',
                en: 'Professional operation aims at stable occupancy and income, with minimal owner effort.',
              },
            },
            {
              ...
              text: {
                ja: '海上の独立した住空間。希少性が高く、資産価値の保全に向きます。',
                en: 'Standalone homes on the water — high scarcity, well suited to preserving value.',
              },
            },
            {
              ...
              text: {
                ja: '利用と運用の両立。別荘利用と賃貸収益のバランスを取りたい方に。',
                en: 'Use and income in balance — for those who want both a retreat and a return.',
              },
            },
          ],
        },
