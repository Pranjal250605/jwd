    ...
    <section id="knowledge" className="relative overflow-hidden bg-washi py-28 lg:py-36">
      <div className="mx-auto max-w-screen-xl px-7 lg:px-12">
        <Reveal className="mb-14 flex items-end justify-between gap-6">
          ...
          <a
            href="#knowledge"
            className="hidden whitespace-nowrap border-b border-gold/40 pb-1 text-[11px] uppercase tracking-[0.2em] text-gold transition-colors hover:text-sumi sm:block"
          >
            {t('viewAll')}
          </a>
        </Reveal>
            ...
            <Reveal key={n} delay={0.1 + i * 0.1}>
              <article className="group flex h-full flex-col gap-5 bg-washi p-8 transition-colors duration-500 hover:bg-washi-deep">
                <div className="flex items-center gap-4">
                  <span className="font-mono text-[10px] text-sumi/40">
                    {t(`date${n}`)}
                  </span>
                  <span className="border border-gold/30 px-2.5 py-1 text-[9px] tracking-[0.2em] text-gold">
                    {t(`tag${n}`)}
                  </span>
                </div>
                <p className="text-[0.85rem] font-light leading-[2] text-sumi-soft">
                  {t(`text${n}`)}
                </p>
