...
function TiltStatCard({
  ...
  const glow = useMotionTemplate`radial-gradient(circle at ${mx}% ${my}%, rgba(0,151,167,0.20), transparent 55%)`;
  ...
  return (
    <section className="relative overflow-hidden bg-washi-deep py-28 lg:py-36">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 20% 90%, rgba(0,151,167,0.08), transparent 65%)' }}
      />
