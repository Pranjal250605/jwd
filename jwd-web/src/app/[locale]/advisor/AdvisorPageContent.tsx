          ...
          <Reveal delay={0.15}>
            <div className="flex flex-col gap-8">
              ...
              <div className="rounded-xl border border-sumi/8 bg-washi p-6">
                ...
                <div className="flex items-center gap-2 text-[14px] text-sumi-soft/50">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                  <span>Powered by Google Gemini</span>
                </div>
                <button
                  onClick={() => window.dispatchEvent(new CustomEvent('advisor-new-chat'))}
                  className="mt-4 w-full rounded-lg border border-sumi/10 px-4 py-2 text-sm text-sumi-soft transition-colors duration-300 hover:border-gold/40 hover:text-sumi"
                >
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    >
                      ...
                      <span className="text-sm text-sumi/55 transition-colors group-hover:text-gold">
                        →
                      </span>
                    </Link>
                  ))}
              ...
              {/* Disclaimer */}
              <p className="text-sm leading-relaxed text-sumi/55 px-1">
                {t('disclaimer')}
              </p>
            </div>
          </Reveal>
